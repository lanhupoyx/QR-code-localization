// Generated by gencpp from file ep_qrcode_loc/CameraFrame_msg.msg
// DO NOT EDIT!


#ifndef EP_QRCODE_LOC_MESSAGE_CAMERAFRAME_MSG_H
#define EP_QRCODE_LOC_MESSAGE_CAMERAFRAME_MSG_H
...
struct CameraFrame_msg_
{
  typedef CameraFrame_msg_<ContainerAllocator> Type;
  ...
  CameraFrame_msg_(const ContainerAllocator& _alloc)
    : stamp()
    , sender(_alloc)
    , hex(_alloc)
    , head(_alloc)
  ...
  typedef boost::shared_ptr< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> const> ConstPtr;

}; // struct CameraFrame_msg_

typedef ::ep_qrcode_loc::CameraFrame_msg_<std::allocator<void> > CameraFrame_msg;

typedef boost::shared_ptr< ::ep_qrcode_loc::CameraFrame_msg > CameraFrame_msgPtr;
typedef boost::shared_ptr< ::ep_qrcode_loc::CameraFrame_msg const> CameraFrame_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator1> & lhs, const ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8b572640966fd882ULL;
  static const uint64_t static_value2 = 0x205a439970453d98ULL;
};

template<class ContainerAllocator>
struct DataType< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ep_qrcode_loc/CameraFrame_msg";
  }
...
template<class ContainerAllocator>
struct Definition< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ep_qrcode_loc::CameraFrame_msg_<ContainerAllocator>& v)
  {
    s << indent << "stamp: ";
...
#endif // EP_QRCODE_LOC_MESSAGE_CAMERAFRAME_MSG_H
