...
// 采集二维码位姿模式
void QRcodeLoc::CollectQRCodePose_mode()
{
...
// 采集二维码编号模式
void QRcodeLoc::CollectQRCodeIndex_mode()
{
...
// 检查相机水平模式
void QRcodeLoc::CheckCameraHorizon_mode()
{
...
// 代码测试
void QRcodeLoc::CodeDebug_mode()
{
    logger->info("CodeDebug_mode()");
...
// 辅助驾驶
void QRcodeLoc::AssistedDriving_mode()
{
    logger->info("AssistedDriving_mode()");
